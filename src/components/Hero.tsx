    ...
    <>
      <div className="max-w-7xl m-auto md:mt-4 lg:mt-6 px-6 flex flex-col lg:flex-row gap-6">
        <div className="space-y-4">
          ...
          <div className="md:flex space-y-4 md:items-start">
            ...
            <div className="space-y-4 md:flex md:flex-col md:w-1/2 md:h-[180px] lg:h-[180px] md:justify-between md:items-start ">
              ...
              <button className="uppercase shadow bg-[#F15E50] hover:bg-[#000019] focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded ">
                Read more
              </button>
            </div>
          </div>
        ...
        <div className="m-auto mt-4 md:mt-0  px-4 py-4 md:px-20 md:py-8 lg:px-4 lg:py-4 bg-[#000019] text-white rounded">
          <h2 className="text-orange-400 text-3xl font-bold mb-6">New</h2>
          <h3 className="font-bold text-xl mb-2 hover:text-[#F15E50] cursor-pointer">
          ...
          <hr />
          <h3 className="font-bold text-xl my-2 hover:text-[#F15E50] cursor-pointer">
